...
//         doctor = await AppointmentController.getPatientById(appointment.doctorid!);
//         appointmentList.add(AppointmentCard(
//           doctorName: "Dr. ${doctor.first.name}",
...
//       });
//     } else {
//       final acceptedAppointments = await AppointmentController.getAcceptedAppointment();
//       List<AppointmentCard> appointmentList = [];
//       List<Doctor> doctor = [];
//       for (var appointment in acceptedAppointments) {
//         List<String> dateArray = appointment.date!.split("-");
...
//         );
//         String dateFormatted = DateFormat('EEEE, d MMMM').format(date);
//         doctor = await AppointmentController.getPatientById(appointment.patientid!);
//         appointmentList.add(AppointmentCard(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Container(
            ...
            //     ),
            //     !isDoctor
            //         ? MenuOption(menuTitle: "Accepted Appointment",)
            ...
            //                       patient = await AppointmentController.getPatientById(
            ...
            //                 InkWell(
            //                   onTap: () async {
            //                     final pendingAppointments = await AppointmentController
            ...
            //                         await AppointmentController.getRejectedAppointment();
            //                     List<AppointmentCard> appointmentList = [];
            //                     List<Doctor> patient = [];
